      ...
      <div className="postBoxContainer">
        {post.length != 0 && (
          <PostBox
            ...
            postMediaArray={
              post.media_array ? JSON.parse("[" + post.media_array + "]") : []
            }
        ...
        <div className="commentBoxContainer">
          ...
          {comments.length > 0 ? (
            comments.map(function (comment) {
              return (
                <CommentBox
                  commentatorId={comment.commentator_id}
                  commentatorPicture={comment.commentator_picture}
                  commentContent={comment.comment_content}
                  commentatorName={comment.commentator_name}
                  commentTimeAgo={comment.comment_time_ago}
                />
              );
            })
          ) : (
