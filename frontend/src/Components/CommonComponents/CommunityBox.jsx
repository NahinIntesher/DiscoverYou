        ...
        if (res.data.status === "Registered") {
          axios
            .post("http://localhost:3000/student/notifications", {
              ...
              notificationMessage: `${user.student_name} wants to join your ${name} community!`,
              notificationLink: `/community/members/pending`,
            })
            .then((res) => {
    ...
    <div className="communityBox">
      <div className="informationContainer">
        ...
        <div className="joinButtonContainer">
          {joinStatus == "yes" ? (
            <Link to={"/community/" + id} className="joinButton">
              Enter
            </Link>
          ) : joinStatus == "pending" ? (
