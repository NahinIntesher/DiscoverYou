...
export default function ChangeProfilePicture({ user, setUser }) {
  ...
  const [currentProfilePicture, setCurrentProfilePicture] = useState(user.student_picture ? user.student_picture : dp);
  ...
  const handleSubmit = (e) => {
    ...
    axios.defaults.withCredentials = true;
      ...
      axios
        .post("http://localhost:3000/student/profile/update-profile", finalData,
        {
          headers: {
        ...
        .then((res) => {
          if (res.data.status === "Success") {
            ...
            setUser(function(prev){
              return {
                ...prev,
                student_picture: prev.student_picture ? prev.student_picture+"?new" : "http://localhost:3000/student/profile/picture/"+prev.student_id
              }
            });
