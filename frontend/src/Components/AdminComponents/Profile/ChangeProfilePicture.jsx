...
export default function ChangeProfilePicture({ user, setUser }) {
  ...
  const [currentProfilePicture, setCurrentProfilePicture] = useState(user.admin_picture ? user.admin_picture : dp);
  ...
  const handleSubmit = (e) => {
    ...
    axios.defaults.withCredentials = true;
      ...
      axios
        .post("http://localhost:3000/admin/profile/update-profile", finalData,
        {
          headers: {
        ...
        .then((res) => {
          if (res.data.status === "Success") {
            ...
            setUser(function(prev){
              return {
                ...prev,
                admin_picture: prev.admin_picture ? prev.admin_picture+"?new" : "http://localhost:3000/admin/profile/picture/"+prev.admin_id
              }
            });
