          ...
          if (res.data.message == "Liked") {
            axios
              .post("http://localhost:3000/student/notifications", {
                ...
                notificationMessage: `${user.organizer_name} liked your post in showcase!`,
            ...
            admins.map((admin) => {
              axios
                .post("http://localhost:3000/admin/notifications", {
                  ...
                  notificationMessage: `${user.organizer_name} reported in ${posterName}'s post. Please check the details!`,
                  notificationLink: `/showcase/post/${postId}`,
                })
                .then((res) => {
                  if (res.data.status === "Success") {
