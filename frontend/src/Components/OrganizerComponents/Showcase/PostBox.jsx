...
export default function PostBox({postId, posterId, posterName, posterPicture, postContent, postTime, postTimeAgo, postMediaArray, isPostReacted, postReactionCount, postCommentCount}) {
    ...
    function reactPost() {
        ...
        axios
        .post("http://localhost:3000/organizer/showcase/react", {
            postId: postId
        })
        .then((res) => {
