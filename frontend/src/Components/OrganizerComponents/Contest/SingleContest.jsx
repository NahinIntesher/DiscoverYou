...
const SingleContest = () => {
  ...
  const submission = async (e) => {
    ...
    const sortedParticipants = [...participantResults].sort((a, b) => b.result_position - a.result_position);
    ...
    try {
      ...
      const resultGivingResponse = await axios.post("http://localhost:3000/organizer/contests/give-result", {
  ...
  return (
    <div className="mainContent">
      ...
      <div className="tabContainer">
        ...
        {
          (data.contest.contest_type == "previous" && !isResultGiven) &&
          <div className={activeTab == "submissions" ? "activeTab" : "tab"} onClick={function () { setActiveTab("submissions") }}>Submit Results</div>
        }
  ...
  return (
    <div className="participant">
      ...
      <div className="participantResult">
        {contestType != "upcoming" && <div className="submission">
          {isSubmitted ?
...
function ParticipantResultGiveBox({ id, name, picture, isSubmitted, contestId, handleChange }) {
  return (
    <div className="participant">
      <div className="profilePicture">
        <img src={picture ? picture : dp} />
